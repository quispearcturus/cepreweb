...
export class SpecialtyEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe(res => {
      this.idSpecialty = parseInt(res['idSpecialty']);
      this.specialtyGetById(this.idSpecialty);
    });


  }

  specialtyGetById(idSpecialty: number): void {
    this.specialtyService.getById$(idSpecialty).subscribe(resopnse => {
      this.specialty = resopnse.data;
      // @ts-ignore
  ...
  public saveForm(): void {
    if (this.specialtyForm.valid) {
      ...
      this.confirmDialogService.confirmUpdate().then(() => {
        this.specialtyService.update$(this.idSpecialty, this.specialtyForm.value).subscribe(response => {
