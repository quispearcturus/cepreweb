      ...
      <div class="responsive-table">
          <table class="table table-lg table-hover table-striped table-sm">
              ...
              <tr>
                  ...
                  <th scope="col">Resolución Directorial</th>
                  <th scope="col">Estado</th>
                  <th scope="col">Acciones</th>
              </tr>
              </thead>
              <tbody class="table-group-divider">
              <tr *ngFor="let v of cycleLevels ; let i=index">
                  <th scope="row">{{i + 1}}</th>
                  <td data-title="Año">{{v.nombre}}</td>
                  <td data-title="Periodo">{{v.resolucion_directoral}}</td>
...
export class CycleLevelListComponent implements OnInit {
  abcForms: any;
  @Input() cycleLevels: CycleLevel[] = [];
