    ...
    <div>
      ...
      >
        ...
        <div class="form-group col-md-2 required">
          <div class="input-group input-group-sm">
            <label class="col-form-label"
              ><b>Descripcion </b><span class="text-danger">(*)</span></label
            >
          </div>
          <div class="input-group input-group-sm input-group-rounded">
            <input
        ...
        <div class="form-group col-md-2 required">
          ...
          <div class="input-group input-group-sm input-group-rounded">
            <input
              ...
              placeholder="capacidad_laboratorio"
            />
          </div>
          <app-form-validate-errors
            [group]="laboratoryForm"
...
export class LaboratoryEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe((res) => {
      this.idLaboratory = parseInt(res['idLaboratory']);
      this.laboratoryGetById(this.idLaboratory);
    });
  }

  laboratoryGetById(idLaboratory: number): void {
    this.laboratoryService.getById$(idLaboratory).subscribe((resopnse) => {
      this.laboratory = resopnse.data;
      // @ts-ignore
      this.laboratoryForm.patchValue(this.laboratory);
    });
  }
      ...
      this.confirmDialogService
        ...
        .then(() => {
          this.laboratoryService
            .update$(this.idLaboratory, this.laboratoryForm.value)
            .subscribe(
              (response) => {
