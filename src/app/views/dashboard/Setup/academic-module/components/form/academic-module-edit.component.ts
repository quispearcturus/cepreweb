...
export class AcademicModuleEditComponent implements OnInit {
  abcForms: any;
  public error: string = '';
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe(res => {
      this.idModule = parseInt(res['idModule']);
      this.GetById(this.idModule);
    });
    this.getLevelCicles();
    this.getSpecialties();
    this.getTypeProgram();
  ...
  public saveForm(): void {
    if (this.moduleForm.valid) {
      ...
      this.confirmDialogService.confirmSave().then(() => {
        this.academicModuleService.update$(this.idModule,this.moduleForm.value).subscribe(response => {
